...
def f_liste_distance_des_ST(df, distance_de_1_tour, distance_toute_la_course):
    ...
    for index_colonne, nom_colonne in enumerate(colonnes_df):
        if nom_colonne == "→ Shooting 1":
            liste_distance_au_depart_des_ST.append(distance_de_1_tour)
        elif nom_colonne == "Shooting 1":
            liste_distance_au_depart_des_ST.append(liste_distance_au_depart_des_ST[-1])        
        elif nom_colonne == "→ Shooting 2":
    ...
    liste_distance_au_depart_des_ST_sans_doublons = []
    [liste_distance_au_depart_des_ST_sans_doublons.append(x) for x in liste_distance_au_depart_des_ST if x not in liste_distance_au_depart_des_ST_sans_doublons]
    ...
    return liste_distance_des_ST, liste_distance_au_depart_des_ST, liste_distance_au_depart_des_ST_sans_doublons
...
def f_df_sans_temps_shoot(df, nombre_de_shoots):
    ...
    return df_temps_de_ski, df_chute_perf_62, df_chute_perf_nat_10, index_avant_shoot_1, index_avant_shoot_2, temps_shoot_1, temps_shoot_2, df_sans_temps_shoot, index_avant_shoot_3, index_avant_shoot_4
