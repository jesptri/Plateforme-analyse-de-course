...
data_fis_path_pursuit_pdf = "c:\\Users\\jules\\Desktop\\Stage CNSNMM\\Analyse de course\\Ski de fond\\resultats FIS mail\\2024CC2274AL.pdf"
data_fis_path_sprint_pdf = "c:\\Users\\jules\\Desktop\\Stage CNSNMM\\Analyse de course\\Ski de fond\\resultats FIS mail\\2024CC2289AL.pdf"


def extraction_data_fis(data_fis_path_pdf):
    ...
    data_fis_path_excel = f"c:\\Users\\jules\\Desktop\\Stage CNSNMM\\Analyse de course\\Ski de fond\\resultats FIS\\Ski de fond_Coupe_du_monde_{Lieu_de_la_course}_{Type_de_la_course}_{Saison_de_la_course}.xlsx"
    ...
    column_names = [str(split) + "km" for split in liste_split] # liste_split[:-1]]
    ...
    return df_ski_de_fond, liste_split


# extraction_data_fis(data_fis_path_pursuit_pdf)