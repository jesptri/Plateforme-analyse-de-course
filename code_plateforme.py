...
csv_st_file_path_split = "jesptri\\Analyse_de_course\\data_utile_csv\\data_listes_split.csv"
csv_st_file_path_type = "jesptri\\Analyse_de_course\\data_utile_csv\\data_listes_type_de_portion.csv"
...
with onglets[5]:
    ...
    if st.session_state.button_clicked_jonas == True:
        ...
        path_check = f"jesptri\\Analyse_de_course\\data_ibu_excel\\{choix_lieu_de_la_course_temporary_jonas}_{choix_type_de_la_course_temporary_jonas}_{choix_saison_temporary_jonas}.xlsx"
...
with onglets[0]:
    ...
    if file_path.is_file() and is_zipfile_valid(file_path):
        ...
        df = pd.read_excel(f"jesptri\\Analyse_de_course\\data_ibu_excel\\{choix_lieu_de_la_course}_{choix_type_de_la_course}_{choix_saison}.xlsx", engine='openpyxl')
